...
public class FileSelectionActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            Log.e("INside FileselctionActivty oncreate", ">>>>>>>>>OnCreateside");
            path = (TextView)findViewById(R.id.folderpath);

            loadLists();
        }
        catch(Exception e){
        	System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>In FileSelectionClass"+e);
        }
       ...
       ok.setOnClickListener(new View.OnClickListener() {
		...
		public void onClick(View v) {
			Toast.makeText(getApplicationContext(), 
                    "Files Selected..", Toast.LENGTH_LONG).show();
